...
if (document.images) 
{
  ...
  image_url = new Array();
  image_url[0] = "images/search_hover.png";
...
<body onload="updateClock(); setInterval('updateClock()', 1000 ); loadPresentation();">
    ...
    <div id= "header">
        ...
        <span id = "rightHead"> 
            ...
            <div id = "search">  
                ...
                <input id = "textField" type="text"  name = "pptfilter" value = "Search By Slide Title" />
